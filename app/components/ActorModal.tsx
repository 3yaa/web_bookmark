			...
			<div className={`relative w-full ${colMaxWidth[cols]}`}>
				<AnimatePresence>
					{selectedActor && !actorLoading && (
						...
						>
							<div className="bg-linear-to-b from-zinc-900/70 to-zinc-950/85 rounded-lg border border-zinc-800/50 shadow-2xl shadow-black/80 overflow-hidden">
				...
				>
					...
					<div className="relative flex-1 overflow-y-auto px-6 py-6">
						{actorLoading && (selectedActor || isDirectorView) && (
							<>
									...
									>
										{cast.map((member) => (
											<div
												...
												className="group/actor cursor-pointer bg-linear-to-b from-zinc-900/70 to-zinc-950/85 rounded-lg border border-zinc-800/50 shadow-md shadow-black/50 hover:shadow-xl hover:shadow-black/60 hover:-translate-y-0.5 hover:border-zinc-700/60 transition-all duration-300 ease-out overflow-hidden"
											>
												<div className="relative aspect-2/3 bg-zinc-900 overflow-hidden">
													{member.profile_path ? (
														<Image
