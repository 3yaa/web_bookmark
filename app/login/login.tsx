    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 flex items-center justify-center px-4 py-8">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl bg-gradient-to-b from-zinc-700/30 via-zinc-800/20 to-zinc-900/30 p-0.5">
          {/* Inner card */}
          <div className="bg-gradient-to-br from-zinc-900/90 via-zinc-900/80 to-zinc-950/90 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-8 pb-6">
            {/* Header */}
            <div className="text-center mb-4">
              <h2 className="text-3xl font-bold text-zinc-100 mb-2">Login</h2>
              <p className="text-zinc-400 text-sm">
                Enter xl the mnu wonderland oiui
              </p>
            </div>
