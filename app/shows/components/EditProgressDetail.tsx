...
import { FIELD_LABEL } from "@/app/components/ui/DesktopDetailsUtils";
	...
	return (
		<div className="space-y-1.5 mb-2 w-[94%] mx-auto">
			...
			<div className="flex gap-4">
				{/* SEASON CONTROLS */}
				<div className="flex-1 rounded-lg neu-raised-firm py-1.5 px-3 select-none">
					<div className="flex items-center justify-between pl-1">
						<span
							className="mt-0.5 text-[0.9375rem] text-zinc-300/70 font-bold hover:cursor-pointer"
							onClick={() =>
